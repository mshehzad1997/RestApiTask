...
namespace RestApiTask.Migrations
{
    ...
    [Migration("20220324111958_ForeignKeyPrimaryuKeyAdded")]
    partial class ForeignKeyPrimaryuKeyAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestApiTask.Models.User.UserRole", b =>
                {
            ...
            modelBuilder.Entity("RestApiTask.Models.ManageRoles", b =>
                {
                    b.HasOne("RestApiTask.Models.Users", null)
                        .WithMany("ManageRoles")
                        .HasForeignKey("ManageRoleId");
                });
